...
def get_default_buttons():
    keyboard = [
        [InlineKeyboardButton("💖 JOIN OUR CHANNEL 💖", url="https://t.me/pathanbhai")],
        [InlineKeyboardButton("👻 CONTACT OWNER 👻", url="https://t.me/pathanbhai")]
    ]
...
COOLDOWN_PERIOD = 0  # Default cooldown = 10 minutes
...
async def howtoattack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "📖 *Learn How to Attack:*\n"
        f"[Watch the Tutorial](https://youtube.com/@arifkhan-t1e?si=kP8YStnY4JqhD-k9",
        parse_mode="Markdown"
    )
...
async def canary(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("📱Android Canary📱", url="https://t.me/pathanbhai/143")],
